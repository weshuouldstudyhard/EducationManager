...
<title>CDIOX计划第四小组案例-Forum列表页</title>
</head>
<body>
<s:form id="domainForm" action="forum">
...
<%--       <s:select list="#allDepts" name="baseQuery.deptId" listKey="id" listValue="name" headerKey="-1" headerValue="--请选择--"/> --%>
	...
	<td width="136"><a href="forum_input.action"><img src="images/can_b_02.gif" border="0"/></a></td>
  </tr>
</table>
  ...
  <table id="itemTable" width="100%"  border="1" cellpadding="0" cellspacing="0">
    ...
    <tr align="center" bgcolor="#FFFFFF">
      ...
      <td><img src="images/icon_3.gif" /> <span style="line-height:12px; text-align:center;">
        <a class="xiu" href="#" onclick="updateDomain('forum',${id});">修改</a></span> <img src="images/icon_04.gif" /> 
        <span style="line-height:12px; text-align:center;">
        <a class="xiu" href="#" onclick="deleteDomain(this,'forum_delete.action',${id});">删除</a></span></td>
    </tr>
    </s:iterator>
  </table>
