...
<title>CDIOX计划第四小组案例-Topic列表页</title>
</head>
<body>
<s:form id="domainForm" action="topic">
...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" style="font-size:14px; font-weight:bold; font-family:"黑体";">
  ...
  <tr>
    ...
    <td>
<%--       <s:select list="#allDepts" name="baseQuery.deptId" listKey="id" listValue="name" headerKey="-1" headerValue="--请选择--"/> --%>
    </td>
	<td width="85"><input type="image" src="images/can_b_01.gif"/></td>
	<td width="136"><a href="topic_input.action"><img src="images/can_b_02.gif" border="0"/></a></td>
  </tr>
</table>
  ...
  <table id="itemTable" width="100%"  border="1" cellpadding="0" cellspacing="0">
    ...
    <tr align="center" bgcolor="#FFFFFF">
      ...
      <td><img src="images/icon_3.gif" /> <span style="line-height:12px; text-align:center;">
        <a class="xiu" href="#" onclick="updateDomain('topic',${id});">修改</a></span> <img src="images/icon_04.gif" /> 
        <span style="line-height:12px; text-align:center;">
        <a class="xiu" href="#" onclick="deleteDomain(this,'topic_delete.action',${id});">删除</a></span></td>
    </tr>
    </s:iterator>
  </table>
